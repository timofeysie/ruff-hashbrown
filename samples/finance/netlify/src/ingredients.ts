...
function fabricateUnitCostUSD(seed: IngredientSeed, date: Date) {
...
function fabricateLeadTimeDays(seed: IngredientSeed) {
...
const INGREDIENTS: Ingredient[] = INGREDIENT_SEEDS.map((seed) =>
